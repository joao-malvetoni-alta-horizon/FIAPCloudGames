# language: pt-br
Funcionalidade: Atualização de Promoção de Jogos ADMIN
  ...
  Cenário: Tentativa de atualização por usuário sem permissão
    ...
    Quando um usuário comum tentar atualizar essa promoção
  ...
  Cenário: Tentativa de atualização de promoção inexistente
    ...
    Quando um administrador tentar atualizar uma promoção inexistente
  ...
  Cenário: Tentativa de atualização com sobreposição de datas
    ...
    Quando um administrador tentar atualizar essa promoção alterando as datas
