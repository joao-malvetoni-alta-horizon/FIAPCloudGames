...
public interface IUserRepository : IRepository<User>
{
    ...
    /// <summary>Busca um usuário pelo id incluindo seus jogos adquiridos.</summary>
    Task<User?> GetWithOwnedGamesAsync(Guid id, CancellationToken cancellationToken = default);
}
